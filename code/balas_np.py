...
def balas_hammer(matrice_provisions, matrice_couts):
    ...
    while lignes_actives and colonnes_actives:
        ...
        # Trouver le delta maximum entre celui ligne et colonne
        ...
        if max_delta_ligne >= max_delta_colonne:
            ...
            # On prend la colonne avec le coût minimal (si il y a 2 delta le meme, on prend celle avec le plus ptit)
            ...
            # On prend la ligne avec le coût minimal (si il y a 2 delta le meme, on prend celle avec le plus ptit)
